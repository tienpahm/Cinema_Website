...
export default function Header() {
  return (
    <header className="p-4 bg-coolGray-100 text-coolGray-800 bg-gray-900 bg-opacity-50 fixed w-full text-white z-10">
      <div className="container flex justify-between h-16 mx-auto">
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <NavLink
              to="/home"
              className="text-white flex items-center -mb-0.5 border-b-2 px-4 border-transparent">
              Home
            </NavLink>
          </li>
          <li className="flex">
